...
function Choose() {
  return (
    <div className='w-full snap-start lg:p-36   p-9  h-[90vh] bg-monfond items-center flex lg:flex-row flex-col  z-0'>
    <div className='flex w-full lg:w-1/2 h-full flex-col space-y-6'>
            <h1 className=' text-4xl  lg:text-5xl  font-black text-monRose'>Why ÖRFJÄLL ?</h1>
        <div >
